...
describe('ReserveRoomComponent', () => {
  ...
  let mockReserveRoomService;
  let mockDataService

  beforeEach(async(() => {

    mockReserveRoomService = sinon.createStubInstance(ReserveRoomService);
    mockReserveRoomService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: ReserveRoomService, useValue: mockReserveRoomService },
